...
import './RoomDetailsHotel.scss';

const RoomDetailsHotel = (props) => {
  const {
    isModalVisible,
    handleOk,
    handleCancel,
          ...
          <Col span={14} className="images__section">
            ...
            <div className="images__group">
              {roomData.images.map((item, index) => {
                return <Image preview={false} src={item.src} key={index} />;
              })}
            </div>
          </Col>
...
export default RoomDetailsHotel;
